...
export default function RoomDetails() {
  return (
    <ScrollArea className="h-[40vh] scroll-smooth rounded-md border border-border/60 bg-background p-4 text-muted">
      ...
      <p className="mb-1 text-xs font-semibold">
        Owner:{" "}
        <span className="text-highlighted">{ROOM_DETAILS.owner as string}</span>
      </p>
      <p className="mb-1 text-xs font-semibold">
        Branch: <span className="text-highlighted">development</span>
      </p>
      <h2 className="my-3 text-lg font-semibold">Room Description</h2>
      <p className="mb-1 text-sm">{ROOM_DETAILS.description}</p>
