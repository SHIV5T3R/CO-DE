...
const commands = {
  help: (
    <span>
      ...
      <strong>None of the following commands are implemented yet!</strong><br />
      <strong>git_clone &lt;URL&gt;</strong> - retrieve a repo from a hosted
      location via URL. <br />
      <strong>git_add &lt;FILE&gt;</strong> - add a file as it looks now to next
      commit. <br />
      <strong>git_commit_m &apos;MESSAGE&apos;</strong> - commit a change to
      repo with the MESSAGE. <br />
      <strong>git_push_origin &lt;BRANCH&gt;</strong> - push a change to repo
      BRANCH. <br />
...
export default function Terminal() {
  ...
  return (
    <section className="h-full">
      ...
      <ReactTerminal
        commands={commands}
        theme={theme === "light" ? "tokyo-night-light" : "tokyo-night-storm"}
